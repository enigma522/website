---
title: "About Me"
keywords: ["Cybersecurity", "CTF", "Enigma522", "HackTheBox", "Bug Bounty", "Ethical Hacking"]
description: "Learn more about Mohamed Masmoudi (Enigma522), a cybersecurity enthusiast focused on CTFs, HackTheBox, and vulnerability research."
---
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" />


<img src="../images/me.jpeg" alt="Me" style=" width: 200px; margin-right: 15px; border-radius: 8px;">

Hi! I’m Mohamed Masmoudi (Enigma522), a cybersecurity enthusiast who loves CTFs, HackTheBox, and digging into vulnerabilities (This is some <strong style="color:#3498db;">[CVEs](/research)</strong> I found).  
This site hosts my writeups and research. Thanks for stopping by!  
Feel free to connect with me on [GitHub](https://github.com/enigma522), [LinkedIn](https://www.linkedin.com/in/mohamed-masmoudi-006066235/).
  ...
  <div style="flex: 1; display: flex; flex-direction: column;">
    <section>
      ...
      <div style="display: flex; align-items: flex-start; gap: 10px;">
          <i class="fas fa-graduation-cap" style="position: relative; top: 4px;"></i> 
          <p style="margin: 0;">
            Software Engineering Degree, 2026<br/>
            <span style="color: gray;">National Institute Of Applied Science And Technology, <strong>INSAT</strong></span>
          </p>
      </div>
    </section>
  </div>
...
- **[C2‑framework](https://github.com/enigma522/C2-framework)**  
...
- **[netcut‑cli](https://github.com/enigma522/netcut-cli)**  
